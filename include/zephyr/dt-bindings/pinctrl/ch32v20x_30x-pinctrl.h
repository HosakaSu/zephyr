...
/* TIM1 - advanced timer, 2-bit remap (PCFR1 bits 6:7).
 * Source: CH32V30x reference manual AFIO remap table / ch32v30xhw.h.
 *   remap 0 (no remap):  ETR/PA12 CH1/PA8 CH2/PA9 CH3/PA10 CH4/PA11
 *                        BKIN/PB12 CH1N/PB13 CH2N/PB14 CH3N/PB15
 *   remap 1 (partial 1): ETR/PA12 CH1/PA8 CH2/PA9 CH3/PA10 CH4/PA11
 *                        BKIN/PA6  CH1N/PA7  CH2N/PB0  CH3N/PB1
 *   remap 2 (partial 2): ETR/PD4  CH1/PD2 CH2/PA1 CH3/PC3  CH4/PC4
 *                        BKIN/PC2  CH1N/PD0  CH2N/PA2  CH3N/PD1
 *   remap 3 (full):      ETR/PE7  CH1/PE9 CH2/PE11 CH3/PE13 CH4/PE14
...
#define TIM1_ETR_PD4_2   CH32V20X_V30X_PINMUX_DEFINE(PD, 4, TIM1, 2)
...
#define TIM1_CH1_PD2_2   CH32V20X_V30X_PINMUX_DEFINE(PD, 2, TIM1, 2)
...
#define TIM1_CH2_PA1_2   CH32V20X_V30X_PINMUX_DEFINE(PA, 1, TIM1, 2)
...
#define TIM1_CH3_PC3_2   CH32V20X_V30X_PINMUX_DEFINE(PC, 3, TIM1, 2)
...
#define TIM1_CH4_PC4_2   CH32V20X_V30X_PINMUX_DEFINE(PC, 4, TIM1, 2)
...
#define TIM1_BKIN_PC2_2  CH32V20X_V30X_PINMUX_DEFINE(PC, 2, TIM1, 2)
...
#define TIM1_CH1N_PD0_2  CH32V20X_V30X_PINMUX_DEFINE(PD, 0, TIM1, 2)
...
#define TIM1_CH2N_PA2_2  CH32V20X_V30X_PINMUX_DEFINE(PA, 2, TIM1, 2)
...
#define TIM1_CH3N_PD1_2  CH32V20X_V30X_PINMUX_DEFINE(PD, 1, TIM1, 2)
#define TIM1_CH3N_PE12_3 CH32V20X_V30X_PINMUX_DEFINE(PE, 12, TIM1, 3)

/* TIM2 - 2-bit remap (PCFR1 bits 8:9).
 *   remap 0: CH1+ETR/PA0 CH2/PA1 CH3/PA2  CH4/PA3
 *   remap 1: CH1+ETR/PA15 CH2/PB3 CH3/PA2  CH4/PA3
 *   remap 2: CH1+ETR/PA0  CH2/PA1 CH3/PB10 CH4/PB11
 *   remap 3: CH1+ETR/PA15 CH2/PB3 CH3/PB10 CH4/PB11
 */
...
/* TIM3 - 2-bit remap (PCFR1 bits 10:11). remap value 1 is reserved.
 *   remap 0: CH1/PA6 CH2/PA7 CH3/PB0 CH4/PB1
 *   remap 2: CH1/PB4 CH2/PB5 CH3/PB0 CH4/PB1
 *   remap 3: CH1/PC6 CH2/PC7 CH3/PC8 CH4/PC9
 */
...
/* TIM4 - 1-bit remap (PCFR1 bit 12).
 *   remap 0: CH1/PB6 CH2/PB7 CH3/PB8 CH4/PB9
 *   remap 1: CH1/PD12 CH2/PD13 CH3/PD14 CH4/PD15
 */
...
/* TODO: TIM5/TIM8/TIM9/TIM10 channel pinmux macros. These timers use PCFR2
 * remap bits and/or package-specific mappings; add when a board needs them.
 */
